...
def _interval_selector() -> selector.NumberSelector:
    """Return a positive whole-day interval selector."""
...
def _options_schema() -> vol.Schema:
    ...
    return _profile_schema().extend(
        {
            vol.Required(CONF_FEEDING_INTERVAL_DAYS): _interval_selector(),
            vol.Required(CONF_SPOT_CLEAN_INTERVAL_DAYS): _interval_selector(),
            vol.Required(CONF_FULL_CLEAN_INTERVAL_DAYS): _interval_selector(),
        }
    )
